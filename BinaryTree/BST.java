...
public class BST<Key extends Comparable<Key>, Value> {
	...
	private String printKeysInOrder(Node x){
		if (x==null)
		{
			...
			this.result1="("+printKeysInOrder(x.left)+")"+x.key+"("+printKeysInOrder(x.right)+")";
			return this.result1;
		}
	}
	...
	public String prettyPrintKeys() {
		String prefix="";
		String result="";
		//result=prettyPrint(root,prefix,result);
		result=prettyPrintKeys(root,prefix,result);
		//TODO fill in the correct implementation.
		return result;
	}

	private String prettyPrintKeys(Node x, String prefix, String result)
	{
		if (x==null)
		{
			result+=prefix+"-null\n";
			...
			result+=(prefix+"-"+x.key+"\n");
			result=(prettyPrintKeys(x.left,prefix+" |",result));
			result=(prettyPrintKeys(x.right,prefix+"  ",result));
		}
		return result;
	}
